<?php
// Database Settings
$CONFIG['sql_host']			=	'sql209.epizy.com';			// ไม่ต้องทำอะไร โดยปกติจะเป็น localhost
$CONFIG['sql_username']		=	'epiz_28273216';			// ระบุ User ของ SQL
$CONFIG['sql_password']		=	'n1GoBCNAYHcei';			// ระบุ Password ของ SQL
$CONFIG['sql_dbname']		=	'epiz_28273216_ragnarok';			// ระบุชื่อฐานข้อมูลของ Ragnarok
$CONFIG['sql_cpdbname']		=	'epiz_28273216_ragnarok';			// ชื่อของฐานข้อมูล CP
...
$CONFIG['language']		=	'Brasil';			// ระบุภาษาของ CP (Thai, English)
$CONFIG['default_theme']		=	'SGCP_Default';		// ระบุชื่อโฟลเดอร์ของ Theme เพื่อให้ใช้เป็น Theme หลัก
$CONFIG['time_offset']		=	'GMT-0300';		// ตั้งค่าโซนเวลา (ค่าปกติ: GMT+0700)
...
// Main Page Settings
$CONFIG['language_select_mode']	=	'1';			// ระบุโหมด Language Select (0: ไม่ใช้งาน 1: ใช้งาน)
$CONFIG['theme_select_mode']	=	'1';			// ระบุโหมด Theme Select (0: ไม่ใช้งาน 1: ใช้งาน)
$CONFIG['show_ro_news_per']		=	'5';			// ระบุตัวเลขเพื่อแสดงจำนวนข่าวต่อหนึ่งหน้า
